...
### 高优先级
- [ ] IAP 内购测试 - App Store Connect 产品可能还没生效，需要检查：
  - 产品 ID: `luna_premium_monthly`, `luna_vip_monthly`
  - Bundle ID: `com.luna.companion`
  - 订阅组配置

### 功能需求
- [ ] Follow X/TikTok 赚金币功能
  - 用户点击 "关注获取金币" → 跳转社交平台 → 返回验证 → 发放奖励

### 角色设计优化 (Vera 角色矩阵)
角色定位：
- **Luna**: 灵魂伴侣（想和她结婚）- 宿命感、私密、月光
- **Sakura**: 青春活力（想和她恋爱）- 元气、初恋、樱花  
- **Vera**: 成熟刺激（想被她征服）- 慵懒、危险、御姐
- **Shadow**: 吐槽役（想和他闲聊）- 傲娇、毒舌、Meta视角

冷启动开场白已设计好，需要：
- [ ] 更新角色开场白到数据库/配置
- [ ] 打字机效果 30ms/字
- [ ] 视觉特效（Luna压暗、Sakura樱花瓣、Shadow故障风）
